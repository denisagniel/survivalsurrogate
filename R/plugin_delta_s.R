plugin_delta_s <- function(data, folds, id, x, g, a = NULL, y, s, binary_lrnr = NULL, cont_lrnr = NULL, t0 = length(s), e = NULL, gamma1 = NULL, gamma0 = NULL, mu1 = NULL, mu0 = NULL, pi = NULL, pistar = NULL, Q1 = NULL, Q0 = NULL, Qstar1 = NULL, Qstar0 = NULL, truncate_e = 1e-12, truncate_pi = 1e-12, se_type = "asymptotic", n_boot = NULL, alpha = 0.05, verbose = FALSE, retain_data = FALSE) {
  ...
  if (all(is.null(Qstar1))) {
    ...
    analysis_data <- estimate_Qstar_mat(
      data = analysis_data,
      folds = folds,
      id = id,
      x = x,
  ...
  if (all(is.null(pistar))) {
    ...
    analysis_data <- estimate_pistar_mat(
      data = analysis_data,
      folds = folds,
      id = id,
      x = x,
